...
if __name__ == "__main__":
	...
	parser.add_argument('--stw', action="store", dest="super_tw", type=int, default=None, help='Supertile width')
	parser.add_argument('--sth', action="store", dest="super_th", type=int, default=None, help='Supertile height')
