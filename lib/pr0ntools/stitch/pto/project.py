...
class PTOProject:
	...
	def regen_hugin(self):
		self.text = self.to_str_core(False)
	
	def regen_pto(self):
		self.text = self.to_str_core(True)
	...
	def regen_line(self, line, key_blacklist = None):
		text = ''
